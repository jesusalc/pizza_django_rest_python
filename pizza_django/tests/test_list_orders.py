...
class ListOrdersTest(TestCase):
    ...
    def setUp(self):
        self.customer1 = Customer.objects.create(name="John Doe",
                                                 address="123 Main St")
        self.order1 = Order.objects.create(customer=self.customer1,
                                           status=OrderStatus.ORDERED)
        self.pizza1 = Pizza.objects.create(order=self.order1,
        ...
        self.customer2 = Customer.objects.create(name="Jane Doe",
                                                 address="456 Main St")
        self.order2 = Order.objects.create(customer=self.customer2,
                                           status=OrderStatus.ORDERED)
        self.pizza2 = Pizza.objects.create(order=self.order2,
                                           flavor=PizzaFlavor.SALAMI,
