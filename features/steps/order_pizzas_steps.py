...
def step_given_register_customer(context):
...
def step_then_my_order_placed(context):
    assert context.order is not None
...
def step_order_a_medium_margarita(context):
    context.execute_steps(
        'When I order a "margarita" pizza of "medium" size and "1" quantity')
...
def step_given_I_can_order_pizza(context):
